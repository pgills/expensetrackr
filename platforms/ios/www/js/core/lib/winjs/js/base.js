...
﻿// Copyright (c) Microsoft Open Technologies, Inc.  All Rights Reserved. Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
WinJS.Utilities._writeProfilerMark("WinJS.2.1 2.0.1.WinJS.2014.4.28 base.js,StartTM");
            ...
            return new WinJS.Promise(
                function (c, e, p) {
                    ...
                    req.onreadystatechange = function () {
                        ...
                        if (req.readyState === 4) {
                            if ((req.status >= 200 && req.status < 300) || (req.status === 0 && options.url.substr(0,5) === "file:")) {
...
(function fragmentLoader2Init(global) {
    ...
    if (true || (global.document && document.implementation.createHTMLDocument && document.location.protocol !== "file:")) {
        WinJS.Namespace.define("WinJS.UI.Fragments", {
...
﻿// Copyright (c) Microsoft Open Technologies, Inc.  All Rights Reserved. Licensed under the Apache License, Version 2.0. See License.txt in the project root for license information.
WinJS.Utilities._writeProfilerMark("WinJS.2.1 2.0.1.WinJS.2014.4.28 base.js,StopTM");
